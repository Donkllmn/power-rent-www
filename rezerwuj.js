...
(function(){
  ...
  if(pbot){
    ...
    function reply(txt){
      ...
      if(/kontakt|telefon|adres|gdzie|mail|dojazd|numer/.test(s)) return 'Power Rent · ul. Mokra 2A, 26-600 Radom.<br>Tel: <a href="tel:+48664201202">664 201 202</a> / <a href="tel:+48692422337">692 422 337</a><br>E-mail: <a href="mailto:Faktury2@power.radom.pl">Faktury2@power.radom.pl</a>';
